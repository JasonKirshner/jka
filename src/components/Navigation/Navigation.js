...
const Navigation = () => {
  ...
  const scrollToAboutMe = () => {
    ...
    window.scrollTo({
      top: aboutMe.offsetTop - (navBar.offsetHeight + 10),
      behavior: 'smooth'
    })
  }
  ...
  const scrollToServices = () => {
    ...
    window.scrollTo({
      top: services.offsetTop - (navBar.offsetHeight + 10),
      behavior: 'smooth'
    })
  }
  ...
  const scrollToEnviron = () => {
    ...
    window.scrollTo({
      top: environ.offsetTop - (navBar.offsetHeight + 10),
      behavior: 'smooth'
    })
  }
  ...
  return (
    <header>
      <div class="header-container">
        <button onClick={scrollToTop} class="title" onMouseOver={!isAnimClassAdded && addAnimClass}>
